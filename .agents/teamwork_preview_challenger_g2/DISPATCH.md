...
You are Challenger 2 (Adversarial Stress Testing: Dynamic Storefront, Cart/Checkout & E2E Validation).
Your working directory is: e:\Antigravity\Cadde Store\.agents\teamwork_preview_challenger_g2

Read the authoritative user request at:
e:\Antigravity\Cadde Store\.agents\ORIGINAL_REQUEST.md

Your task:
1. Write and execute an empirical adversarial stress test suite in `tests/e2e/challenger2-storefront-adversarial.test.js` targeting:
   ...
   - Full regression execution of the 266-test master test runner: `node tests/e2e/runner.js`.
