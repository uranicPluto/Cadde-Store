...
export const AdminSidebar: React.FC<{ className?: string }> = ({ className }) => {
  ...
  const navItems = [
    ...
    { href: "/admin/cms", icon: Sliders, label: isEn ? "Homepage Studio" : "Vitrin Stüdyosu" },
    { href: "/admin/pages", icon: Layers, label: isEn ? "Pages & CMS" : "Sayfa Yönetimi" },
    { href: "/admin/appearance", icon: Palette, label: isEn ? "Global Appearance" : "Görünüm & Tasarım" },
    { href: "/admin/layouts", icon: Layers, label: isEn ? "Page Layouts" : "Sayfa Düzenleri" },
    ...
    { href: "/admin/ai-assistant", icon: Sparkles, label: isEn ? "AI Merchandising" : "AI Vitrin Asistanı" },
